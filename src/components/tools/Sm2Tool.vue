  ...
  <div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg p-6">
      <div class="mb-6">
        ...
        <p class="mt-3 p-3 border-l-4 border-amber-400 bg-amber-50 text-amber-900 text-sm" role="alert">
          当前实现用于兼容和调试。底层依赖存在已公开的安全风险，请不要在此页面生成、保存或处理生产私钥，生产签名与加密应使用经过安全审计的国密服务或硬件密钥。
        </p>
      </div>
